...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/fragrant-term-2137
```

A live public deployment of this template is available at [https://fragrant-term-2137.templates.workers.dev](https://fragrant-term-2137.templates.workers.dev)
